public class Wordle {
   ...
   public static void computeFeedback(String secret, String guess, char[] resultRow) {
    ...
    // For example, if guess is HELLO, and row is 2, then after this function 
	...
	int count = 0;
    for (int i =0;resultRow.length>i;i++){
        if (resultRow[i] == 'G') {count++;}
     }
     if (count == resultRow.length){return true;}
     return false;
    }
